...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/kds/sqlite.db",
        sqlite_db="/var/lib/kds/sqlite.db")
...
from kds.openstack.common.db import exception
from kds.openstack.common.gettextutils import _  # noqa
    ...
    def _do_query(self, q):
        ...
        for filename, line, method, function in traceback.extract_stack():
            ...
            if filename.endswith('db/api.py'):
                continue
            # only trace inside kds
            index = filename.rfind('kds')
            if index == -1:
                continue
